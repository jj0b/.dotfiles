...
_G.packer_plugins = {
  ...
  ["git.nvim"] = {
    loaded = true,
    path = "/Users/jason/.local/share/nvim/site/pack/packer/start/git.nvim",
  ...
  ["nord.nvim"] = {
    loaded = true,
    path = "/Users/jason/.local/share/nvim/site/pack/packer/start/nord.nvim",
  ...
  ["nvim-bufferline.lua"] = {
    loaded = true,
    path = "/Users/jason/.local/share/nvim/site/pack/packer/start/nvim-bufferline.lua",
  ...
  ["prettier.nvim"] = {
    loaded = true,
    path = "/Users/jason/.local/share/nvim/site/pack/packer/start/prettier.nvim",
